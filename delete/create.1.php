...
<body>
    <div id="errortext"></div>
        <form class="m-t" role="form1" id="form2" action="invoice.php" method="post" autocomplete="off" onsubmit="ajaxCall(this, 'createinvoice'); return false;">
        ...
        <form class="m-t" role="form" id="form2" action="invoice.php" method="post" autocomplete="off" onsubmit="ajaxCall(this, 'createitem'); return false;">
            <div class="form-group">
